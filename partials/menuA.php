...
<div id="barra-lateral" style="background-color: #3365A6;">
     ...
     <div  id="contenedor-logos-primero" class="contenedor-logos">
        ...
        <a  href="admin/usuario.php" class="title-menu" class="fa fa-sign-out fa-fw" style="color: #F2E63D;"><?php echo $_SESSION["username"]; ?></a>
    </div>
    ...
    <div style="font-size:12px;" class="contenedor-logos">
        ...
        <a  href="admin/clientes.php" class="title-menu" class="fa fa-sign-out fa-fw" style="color: #ffffff;">CLIENTES</a>
    </div>
    ...
    <div style="font-size:12px;" class="contenedor-logos">
        ...
        <a  href="admin/factura.php" class="title-menu" class="fa fa-sign-out fa-fw" style="color: #ffffff;">REGISTRAR FACTURA</a>
    </div>
    ...
    <div style="font-size:12px;" class="contenedor-logos">
        ...
        <a  href="admin/consultar_f.php" class="title-menu" class="fa fa-sign-out fa-fw" style="color: #ffffff;">CONSULTAR FACTURAS</a>
    </div>
    ...
    <div style="font-size:12px;" class="contenedor-logos">
        ...
        <a  href="admin/Precios.php" class="title-menu" class="fa fa-sign-out fa-fw" style="color: #ffffff;">PRECIOS</a>
    </div>
