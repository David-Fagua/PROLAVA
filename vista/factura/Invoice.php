...
class Invoice{
	...
	public function saveInvoice($POST) {		
		$sqlInsert = "
			INSERT INTO ".$this->invoiceOrderTable."(user_id, celular, fecha_entrega, order_receiver_name, addresss, order_total_before_tax, order_total_tax, order_tax_per, order_total_after_tax, order_amount_paid, order_total_amount_due, note, dir_entrega) 
			VALUES ('".$POST['userId']."', '".$POST['celular']."', '".$POST['fecha_entrega']."', '".$POST['companyName']."', '".$POST['addresss']."', '".$POST['subTotal']."', '".$POST['taxAmount']."', '".$POST['taxRate']."', '".$POST['totalAftertax']."', '".$POST['amountPaid']."', '".$POST['amountDue']."', '".$POST['notes']."', '".$POST['dir_entrega']."')";		
	...
	public function updateInvoice($POST) {
		if($POST['invoiceId']) {	
			$sqlInsert = "
				...
				SET order_receiver_name = '".$POST['companyName']."', celular= '".$POST['celular']."', fecha_entrega= '".$POST['fecha_entrega']."', addresss= '".$POST['addresss']."', order_total_before_tax = '".$POST['subTotal']."', order_total_tax = '".$POST['taxAmount']."', order_tax_per = '".$POST['taxRate']."', order_total_after_tax = '".$POST['totalAftertax']."', order_amount_paid = '".$POST['amountPaid']."', order_total_amount_due = '".$POST['amountDue']."', note = '".$POST['notes']."', dir_entrega = '".$POST['dir_entrega']."' 
